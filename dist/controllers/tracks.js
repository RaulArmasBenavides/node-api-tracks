...
const getItem = async (req, res) => {
    try {
        ...
        if (!track) {
            return res
                .status(404)
                .json({ ok: false, msg: 'Canción no encontrada por id' });
        }
...
const updateItem = async (req, res) => {
    ...
    try {
        ...
        const trackUpdated = await track_1.default.findByIdAndUpdate(id, req.body, {
            new: true,
        });
...
const deleteItem = async (req, res) => {
    ...
    try {
        ...
        if (!track) {
            return res
                .status(404)
                .json({ ok: false, msg: 'Track no encontrado por id' });
        }
...
exports.default = {
    ...
    getItemsFromDB: exports.getItemsFromDB,
